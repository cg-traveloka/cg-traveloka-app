        ...
        <div>
            ...
            <div>
                <div className="w-full" style={{ color: "rgb(76,76,76)" }}>
                    <div className="w-4/5 mx-auto my-4 text-sm">
                        <Link to="/tera/flight" className="mx-2">
                            Chuyến bay
                        </Link>
                        <span className="mx-2">|</span>
                        <Link to="/tera/hotel" className="mx-2">
                            Khách sạn
                        </Link>
                        <span className="mx-2">|</span>
                        <Link to="/tera/room" className="mx-2">
                            Phòng
                        </Link>
                    </div>
                </div>
                ...
                >
                    ...
                    >
                        ...
                        <div
                            className="mx-4 text-white rounded-md mt-4 w-4/12 mx-auto mb-5 mt-6"
