    ...
    <div className="edit-booking-hotel mx-auto my-auto w-8/12 pt-5">
      <div className="flex">
        ...
        <div className="right-content w-4/5 pl-5">
          ...
          <div className="mt-5 shadow-md bg-gray rounded-lg border-solid border-2 border-gray-200 font-sans">
            <div className="my-3">
              ...
              <div className="flex mb-5 justify-between">
                ...
                >
                  <p className="text-center">Đang đợi thanh toán</p>
                </div>
