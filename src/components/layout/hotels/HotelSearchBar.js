...
function HotelSearchBar(params) {
    ...
    const [night, setNight] = useState({ label: "1 đêm", value: 1 })
        ...
        <div className="hotelSearchBar">
            <div className='hotelSearchBarContainer'>
                <div className="grid grid-cols-12 gap-4 content">
                    ...
                    <div className="col-span-3 item">
                        <CalenderIcon />
                        <input onClick={handleOpenCalendar} className='calendarSelected' type="text" value={date.toLocaleDateString("vi-VN", options)} readOnly />
                        <div onMouseLeave={handleCloseCalendar}
                    ...
                    <div className="col-span-2 item">
                        <PersonAndRoomIcon />
                        <input onClick={handleOpenPersonAndRoom} className='personAndRoomInput'
                            type="text" readOnly value={`${hotel.personQuantity} người, ${hotel.roomQuantity} phòng`} />
                        <div onMouseLeave={handleClosePersonAndRoom} style={{ display: personAndRoomDisplay }} className='selectPersonAndRoomContainer'>
                            <div className='personQuantityContainer'>
                                ...
                                <div className='rightItem'>
                                    <button onClick={handleSubPersonQuantity} className='button'><SubIcon /></button>
                                    <input className='personQuantityInput' value={hotel.personQuantity} type="text" readOnly />
                                    <button onClick={handlePlusPersonQuantity} className='button'><PlusIcon /></button>
                                </div>
                            </div>
                            <div className='roomQuantityContainer'>
                                ...
                                <div className='rightItem'>
                                    <button onClick={handleSubRoomQuantity} className='button'><SubIcon /></button>
                                    <input className='roomQuantityInput' value={hotel.roomQuantity} type="text" readOnly />
                                    <button onClick={handlePlusRoomQuantity} className='button'><PlusIcon /></button>
                                </div>
                            </div>
                            <div>
                            </div>
